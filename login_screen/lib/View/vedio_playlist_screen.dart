...
import 'package:login_screen/View/create_playlist_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          push(context, CreatePlayListScreen());
        },
      ...
      body: SingleChildScrollView(
        child: Column(children: [
          Image(
              ...
              width: 200,
              image: NetworkImage(
                "https://media.istockphoto.com/id/499580590/photo/guitarist-on-stage-for-background-soft-and-blur-concept.webp?b=1&s=612x612&w=0&k=20&c=TqdWpdEN42Lzz3MHH0z-QfCZzGx2nWrjYP5vjOVjT8Y=",
              )),
          Padding(
